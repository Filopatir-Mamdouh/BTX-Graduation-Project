...
class StudentsInformationsScreen extends StatelessWidget {
  const StudentsInformationsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final studentsInformationsProvider =
        Provider.of<StudentsInformationsProvider>(context);
                ...
                children: [
                  ...
                  Expanded(
                    child: DefaultDropDownButton(
                      ...
                      value: level,
                      onChanged: (value) {
                        studentsInformationsProvider.changeLevel(
                            selectedLevel: value);
                      },
                    ),
                  ),
                  ...
                  Expanded(
                    child: DefaultDropDownButton(
                      ...
                      value: department,
                      onChanged: (value) {
                        studentsInformationsProvider.changeDepartment(
                  ...
                  Expanded(
                    child: DefaultDropDownButton(
                      ...
                      value: division,
                      onChanged: (value) {
                        studentsInformationsProvider.changeDivision(

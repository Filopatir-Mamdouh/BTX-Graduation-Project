...
import 'package:btxproject2/Screens/Respond_To_Request/Respond_To_Request.dart';
...
class Main_Screen_Respond_To_Request extends StatelessWidget {
  const Main_Screen_Respond_To_Request({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Responsive(
        ...
        mobile: const Respond_To_Request(),
        tablet: Row(
          children: [
        ...
        desktop: Row(
          children: [
            ...
            Expanded(
              ...
              child: const Respond_To_Request(),
            ),
          ],
        ),
      ),

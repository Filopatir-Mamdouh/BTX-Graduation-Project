...
import 'package:graduation_project/pages/students_affairs/schedule/table_schedule.dart';
import 'package:flutter/material.dart';

class MainScreenTableSchedule extends StatelessWidget {
  const MainScreenTableSchedule({super.key});

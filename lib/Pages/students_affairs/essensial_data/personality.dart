...
class Personality extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    return studentModel.when(
        ...
        data: (context) {
          int? bn = studentModel.value?.birthDate.indexOf('T');
          int? db = studentModel.value?.publishDate.indexOf('T');
          return Scaffold(
            body: Column(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(
                                studentModel.value?.code.toString() ?? '',
                                style: TextStyle(color: color1))),
                      )
                    ],
                  ),
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(studentModel.value?.socialStatus ?? '',
                                style: TextStyle(color: color1))),
                      )
                    ],
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(
                                studentModel.value?.studentId.toString() ?? '',
                                style: TextStyle(color: color1))),
                      )
                    ],
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(
                                studentModel.value?.nationalId.toString() ?? '',
                                style: TextStyle(color: color1))),
                      )
                    ],
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(
                                studentModel.value?.publishDate
                                        .substring(0, (db! - 1)) ??
                                    '',
                                style: TextStyle(color: color1))),
                      )
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(studentModel.value?.publishPlace ?? '',
                                style: TextStyle(color: color1))),
                      )
                    ],
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Center(
                            child: Text(
                                studentModel.value?.acceptanceYear.toString() ??
                                    '',
                                style: TextStyle(color: color1))),
                      )
                    ],
